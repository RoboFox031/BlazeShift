...
@onready var players := {
	...
	player = $hSplitContainer/subViewportContainer/subViewport/track/ScreenPlayer1
	},
	"2": {
	...
	player = $hSplitContainer/subViewportContainer/subViewport/track/ScreenPlayer2}
}
...
func _ready():
	...
	players['1'].player = $hSplitContainer/subViewportContainer/subViewport/track/ScreenPlayer1
	players['2'].player = $hSplitContainer/subViewportContainer/subViewport/track/ScreenPlayer2
